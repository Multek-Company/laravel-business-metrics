...
3. Click **Submit**, paste: `https://github.com/Multek-Company/laravel-business-metrics`
...
Check [packagist.org/packages/multek/laravel-business-metrics](https://packagist.org/packages/multek/laravel-business-metrics) — the new version should appear instantly (webhook is configured).
...
# Specific version
composer require multek/laravel-business-metrics:^1.0

# Update to latest
composer update multek/laravel-business-metrics
```
